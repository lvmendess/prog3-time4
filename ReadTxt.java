...
public class ReadTxt {
    ...
    public static String[] removeAccentsAndCharacters(String[] strs) {
        ...
        for (int i = 0; i < strs.length; i++) {
            result[i] = Normalizer.normalize(strs[i], Normalizer.Form.NFD).replaceAll("[^\\p{ASCII}]", "")
    ...
    /**
     * Divide uma linha de texto em palavras individuais e as insere em uma árvore
     * binária.
     * 
